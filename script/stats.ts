...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/RahulSinghai606/kellton-kratos/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for RahulSinghai606/kellton-kratos...\n")
...
console.log("Fetching npm all-time downloads for kellton-kratos...\n")
const npmDownloads = await fetchNpmDownloads("kellton-kratos")
