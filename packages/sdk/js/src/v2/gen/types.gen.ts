...
/**
 * Server configuration for kratos serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://kellton-kratos.io/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://kellton-kratos.io/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
