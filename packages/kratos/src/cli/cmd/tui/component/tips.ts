export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by Kellton Kratos.",
  "Use {highlight}/redo{/highlight} to restore previously undone messages and file changes.",
  "Run {highlight}/share{/highlight} to create a public link to your conversation at kellton-kratos.io.",
  ...
  "Create {highlight}kratos.json{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/kratos/kratos.json{/highlight} for global config.",
  ...
  "Kellton Kratos auto-handles OAuth for remote MCP servers requiring auth.",
  "Add {highlight}.md{/highlight} files to {highlight}.kratos/command/{/highlight} to define reusable custom prompts.",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  "Add {highlight}.md{/highlight} files to {highlight}.kratos/agent/{/highlight} for specialized AI personas.",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools.",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions.',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands.',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing.',
  "Kellton Kratos auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "Kellton Kratos uses LSP servers for intelligent code analysis.",
  "Create {highlight}.ts{/highlight} files in {highlight}.kratos/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.kratos/plugin/{/highlight} for event hooks.",
  "Use plugins to send OS notifications when sessions complete.",
  "Create a plugin to prevent Kellton Kratos from reading sensitive files.",
  "Use {highlight}kratos run{/highlight} for non-interactive scripting.",
  "Use {highlight}kratos run --continue{/highlight} to resume the last session.",
  "Use {highlight}kratos run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}kratos serve{/highlight} for headless API access to Kellton Kratos.",
  "Use {highlight}kratos run --attach{/highlight} to connect to a running server for faster runs.",
  "Run {highlight}kratos upgrade{/highlight} to update to the latest version.",
  "Run {highlight}kratos auth list{/highlight} to see all configured providers.",
  "Run {highlight}kratos agent create{/highlight} for guided agent creation.",
  "Use {highlight}/kratos{/highlight} in GitHub issues/PRs to trigger AI actions.",
  "Run {highlight}kratos github install{/highlight} to set up the GitHub workflow.",
  "Comment {highlight}/kratos fix this{/highlight} on issues to auto-create PRs.",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews.",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors.',
  "Create JSON theme files in {highlight}.kratos/themes/{/highlight} directory.",
  ...
  "Run {highlight}kratos debug config{/highlight} to troubleshoot configuration.",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/RahulSinghai606/kellton-kratos{/highlight} for containerized use.",
  "Use {highlight}/connect{/highlight} with Kellton Kratos Zen for curated, tested models.",
