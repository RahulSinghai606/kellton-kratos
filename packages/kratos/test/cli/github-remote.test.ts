...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kratos.git")).toEqual({ owner: "sst", repo: "kratos" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kratos")).toEqual({ owner: "sst", repo: "kratos" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kratos.git")).toEqual({ owner: "sst", repo: "kratos" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kratos")).toEqual({ owner: "sst", repo: "kratos" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kratos.git")).toEqual({ owner: "sst", repo: "kratos" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kratos")).toEqual({ owner: "sst", repo: "kratos" })
})
