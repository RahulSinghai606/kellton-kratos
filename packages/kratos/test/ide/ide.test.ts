...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KRATOS_CALLER", () => {
    process.env["KRATOS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KRATOS_CALLER", () => {
    process.env["KRATOS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KRATOS_CALLER", () => {
    process.env["KRATOS_CALLER"] = "unknown"
