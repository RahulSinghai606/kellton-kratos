...
const dir = path.join(os.tmpdir(), "kratos-test-data-" + process.pid)
...
process.env["KRATOS_TEST_HOME"] = testHome
...
const cacheDir = path.join(dir, "cache", "kratos")
...
process.env["KRATOS_DISABLE_MODELS_FETCH"] = "true"
