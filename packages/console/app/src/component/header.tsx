...
import copyLogoSvgLight from "../asset/lander/kratos-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/kratos-logo-dark.svg"
import copyWordmarkSvgLight from "../asset/lander/kratos-wordmark-light.svg"
import copyWordmarkSvgDark from "../asset/lander/kratos-wordmark-dark.svg"
  ...
  return (
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href="/">
          <img data-slot="logo light" src={logoLight} alt="kratos logo light" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="kratos logo dark" width="189" height="34" />
        </A>
      </div>
