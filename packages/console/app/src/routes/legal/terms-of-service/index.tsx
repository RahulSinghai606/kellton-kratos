...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>Kellton Kratos | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="Kellton Kratos terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Kellton Kratos. Please read on to learn the rules and restrictions that govern your use of Kellton Kratos
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Kellton Kratos," "we" and "us"). Your use of the Services in any
                ...
                <a href="/legal/privacy-policy">https://kellton-kratos.io/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-kratos">What is Kellton Kratos?</h2>
              <p>
                Kellton Kratos is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Kellton Kratos Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Kellton Kratos enables you to
              ...
              <p>
                ...
                our site located at kellton-kratos.io, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Kellton Kratos takes the privacy of its users very seriously. For the current Kellton Kratos Privacy Policy, please
                click here{" "}
                <a href="https://kellton-kratos.io/legal/privacy-policy">https://kellton-kratos.io/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Kellton Kratos?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Kellton Kratos;
                </li>
                <li>
              ...
              <p>
                If you use Kellton Kratos with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Kellton Kratos. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Kellton Kratos has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-kratos-ever-change-the-services">Will Kellton Kratos ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                Services"). Please see our Paid Services page <a href="/zen">https://kellton-kratos.io/zen</a> for a
              ...
              <p>
                ...
                <a href="https://kellton-kratos.io/auth">https://kellton-kratos.io/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href="/legal/privacy-policy">https://kellton-kratos.io/legal/privacy-policy</a>, as well as the licenses
                above, to understand how we treat information you provide to us after you have stopped using our
                Services.
              </p>

              <p>
                Kellton Kratos is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Kellton Kratos has the sole right to decide whether you are
              ...
              <p>
                Kellton Kratos and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Kellton Kratos and all such
                parties together, the "Kellton Kratos Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Kellton Kratos Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Kellton Kratos Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Kellton Kratos Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Kellton Kratos's prior written
              ...
              <p>
                ...
                disputes and claims with Kellton Kratos and limits the manner in which you can seek relief from Kellton Kratos. Both
                you and Kellton Kratos acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Kellton Kratos's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Kellton Kratos will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Kellton Kratos will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Kellton Kratos may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Kellton Kratos are instead choosing to have claims and disputes resolved by
                ...
                you and Kellton Kratos over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Kellton Kratos is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Kellton Kratos to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Kellton Kratos agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                relationship with Kellton Kratos.
              </p>
              ...
              <p>
                ...
                the Kellton Kratos may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Kellton Kratos agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Kellton Kratos, and
                ...
                are not an employee, agent, partner, or joint venture of Kellton Kratos, and you do not have any authority of
                any kind to bind Kellton Kratos in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Kellton Kratos
