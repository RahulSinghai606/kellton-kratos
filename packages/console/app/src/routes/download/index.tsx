...
import desktopAppIcon from "../../asset/lander/kratos-desktop-icon.png"
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>Kellton Kratos | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download Kellton Kratos for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="Kellton Kratos Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download Kellton Kratos</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> Kellton Kratos Terminal
            </div>
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("curl -fsSL https://kellton-kratos.io/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>kellton-kratos.io/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g kellton-kratos")}>
                <code>
                  npm i -g <strong>kellton-kratos</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g kellton-kratos")}>
                <code>
                  bun add -g <strong>kellton-kratos</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install kratos")}>
                <code>
                  brew install <strong>kratos</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S kratos")}>
                <code>
                  paru -S <strong>kratos</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> Kellton Kratos Desktop (Beta)
            </div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask kratos-desktop")}>
                <code>
                  brew install --cask <strong>kratos-desktop</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> Kellton Kratos Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://kellton-kratos.io/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> Kellton Kratos Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://kellton-kratos.io/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://kellton-kratos.io/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            <li>
              <Faq question="What is Kellton Kratos?">
                Kellton Kratos is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use Kellton Kratos?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect Kellton Kratos to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, Kellton Kratos works with all popular
            ...
            <li>
              <Faq question="How much does Kellton Kratos cost?">
                Kellton Kratos is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While Kellton Kratos works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in Kellton Kratos. Learn more about{" "}
