...
import video from "../asset/lander/kratos-min.mp4"
import videoPoster from "../asset/lander/kratos-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="kratos">
      {/*<HttpHeader name="Cache-Control" value="public, max-age=1, s-maxage=3600, stale-while-revalidate=86400" />*/}
      <Title>Kellton Kratos | The open source AI coding agent</Title>
        ...
        <div data-component="content">
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">kellton-kratos.io/install</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">kellton-kratos</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">kratos</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is Kellton Kratos?</h3>
              <p>Kellton Kratos is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, Kellton Kratos is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  Kellton Kratos does not store any of your code or context data, so that it can operate in privacy sensitive
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is Kellton Kratos?">
                  Kellton Kratos is an open source agent that helps you write and run code with any AI model. It's available
                  as a terminal-based interface, desktop app, or IDE extension.
                </Faq>
              </li>
              <li>
                <Faq question="How do I use Kellton Kratos?">
                  The easiest way to get started is to read the <a href="/docs">intro</a>.
                </Faq>
              </li>
              <li>
                <Faq question="Do I need extra AI subscriptions to use Kellton Kratos?">
                  Not necessarily, Kellton Kratos comes with a set of free models that you can use without creating an
                  account. Aside from these, you can use any of the popular coding models by creating a{" "}
                  <A href="/zen">Zen</A> account. While we encourage users to use Zen, Kellton Kratos also works with all
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with Kellton Kratos?">
                  Yes, Kellton Kratos supports subscription plans from all major providers. You can use your Claude Pro/Max,
                  ChatGPT Plus/Pro, or GitHub Copilot subscriptions. <a href="/docs/providers/#directory">Learn more</a>
                  .
                </Faq>
              </li>
              <li>
                <Faq question="Can I only use Kellton Kratos in the terminal?">
                  Not anymore! Kellton Kratos is now available as an app for your desktop.
                </Faq>
              </li>
              <li>
                <Faq question="How much does Kellton Kratos cost?">
                  Kellton Kratos is 100% free to use. It also comes with a set of free models. There might be additional costs
              ...
              <li>
                <Faq question="Is Kellton Kratos open source?">
                  Yes, Kellton Kratos is fully open source. The source code is public on{" "}
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that Kellton Kratos has tested and benchmarked
