...
import { Key } from "@kellton-kratos/console-core/key.js"
    ...
    <Show when={isNew()}>
      <div class={styles.root}>
        <div data-component="feature-grid">
          ...
          <div data-slot="feature">
            <h3>No Lock-in</h3>
            <p>Use Zen with any coding agent, and continue using other providers with kratos whenever you want.</p>
          </div>
        </div>
        ...
        <div data-component="next-steps">
          <ol>
            ...
            <li>
              Run <code>kratos auth login</code> and select kratos
            </li>
            <li>Paste your API key</li>
            <li>
              Start kratos and run <code>/models</code> to select a model
            </li>
          </ol>
        </div>
      </div>
