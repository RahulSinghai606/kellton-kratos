...
import type { MessageV2 } from "kratos/session/message-v2"
import type { Message } from "kratos/session/message"
import type { Session } from "kratos/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="kratos version" data-slot="item">
                <div data-slot="icon" title="kratos">
