---
title: TUI
description: Using the Kellton Kratos terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kellton Kratos provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Kellton Kratos starts the TUI for the current directory.
...
When using the Kellton Kratos TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Kellton Kratos. Allows you to select from available providers and add their API keys.
...
Exit Kellton Kratos. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Kellton Kratos config file.
