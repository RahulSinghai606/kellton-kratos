---
title: Share
description: Share your Kellton Kratos conversations.
---

Kellton Kratos's share feature allows you to create public links to your Kellton Kratos conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Kellton Kratos:
...
Kellton Kratos supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Kellton Kratos uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `kratos.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using kratos in your organization.
