...
description: What's new in Kellton Kratos 1.0.
---

Kellton Kratos 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same kratos server.
...
version. However some older versions of Kellton Kratos always grab latest.

To upgrade manually, run

```bash
$ kratos upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ kratos upgrade 0.15.31
```
