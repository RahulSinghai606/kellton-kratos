---
title: SDK
description: Type-safe JS client for kratos server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The kratos JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control kratos programmatically.
...
```bash
npm install @kellton-kratos/sdk
```
...
You can pass a configuration object to customize behavior. The instance still picks up your `kratos.json`, but you can override or add configuration inline:
...
console.log(`Server running at ${kratos.server.url}`)
...
If you already have a running instance of kratos, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@kellton-kratos/sdk"
```
