...
import { AppBaseProviders, AppInterface, PlatformProvider, Platform } from "@kellton-kratos/app"
    ...
    await Promise.resolve()
      .then(() => {
        const notification = new Notification(title, {
          body: description ?? "",
          icon: "https://kellton-kratos.io/favicon-96x96.png",
        })
...
function ServerGate(props: ParentProps) {
  const [status] = createResource(async () => {
    if (window.__KRATOS__?.serverReady) return
