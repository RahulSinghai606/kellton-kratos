import type { ProviderAuthAuthorization } from "@kellton-kratos/sdk/v2/client"
import { Button } from "@kellton-kratos/ui/button"
import { useDialog } from "@kellton-kratos/ui/context/dialog"
import { Dialog } from "@kellton-kratos/ui/dialog"
...
import { List, type ListRef } from "@kellton-kratos/ui/list"
import { ProviderIcon } from "@kellton-kratos/ui/provider-icon"
import { Spinner } from "@kellton-kratos/ui/spinner"
import { TextField } from "@kellton-kratos/ui/text-field"
import { showToast } from "@kellton-kratos/ui/toast"
              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "kratos"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            Kellton Kratos Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                          ...
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://kellton-kratos.io/zen" tabIndex={-1}>
                              kellton-kratos.io/zen
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in Kellton Kratos.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in Kellton Kratos.
                        </div>
