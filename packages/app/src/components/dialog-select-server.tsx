...
export function DialogSelectServer() {
  ...
  return (
    <Dialog title="Servers" description="Switch which Kellton Kratos server this app connects to.">
