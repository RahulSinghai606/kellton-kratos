import { useFilteredList } from "@kellton-kratos/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { FileIcon } from "@kellton-kratos/ui/file-icon"
...
import { Select } from "@kellton-kratos/ui/select"
import { getDirectory, getFilename } from "@kellton-kratos/util/path"
...
import { createOpencodeClient, type Message, type Part } from "@kellton-kratos/sdk/v2/client"
import { Binary } from "@kellton-kratos/util/binary"
import { showToast } from "@kellton-kratos/ui/toast"
import { base64Encode } from "@kellton-kratos/util/encode"
