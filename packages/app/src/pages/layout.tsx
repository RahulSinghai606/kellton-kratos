...
import { base64Decode, base64Encode } from "@kellton-kratos/util/encode"
import { Avatar } from "@kellton-kratos/ui/avatar"
import { ResizeHandle } from "@kellton-kratos/ui/resize-handle"
import { Button } from "@kellton-kratos/ui/button"
import { Icon } from "@kellton-kratos/ui/icon"
import { IconButton } from "@kellton-kratos/ui/icon-button"
import { Tooltip, TooltipKeybind } from "@kellton-kratos/ui/tooltip"
import { Collapsible } from "@kellton-kratos/ui/collapsible"
import { DiffChanges } from "@kellton-kratos/ui/diff-changes"
import { Spinner } from "@kellton-kratos/ui/spinner"
import { Mark } from "@kellton-kratos/ui/logo"
import { getFilename } from "@kellton-kratos/util/path"
import { DropdownMenu } from "@kellton-kratos/ui/dropdown-menu"
import { Session } from "@kellton-kratos/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@kellton-kratos/ui/toast"
import { useGlobalSDK } from "@/context/global-sdk"
import { useNotification } from "@/context/notification"
import { usePermission } from "@/context/permission"
import { Binary } from "@kellton-kratos/util/binary"

import { useDialog } from "@kellton-kratos/ui/context/dialog"
import { useTheme, type ColorScheme } from "@kellton-kratos/ui/theme"
...
export default function Layout(props: ParentProps) {
    ...
    async function pollUpdate() {
      ...
      if (updateAvailable && toastId === undefined) {
        toastId = showToast({
          ...
          description: `A new version of Kellton Kratos (${version}) is now available to install.`,
          actions: [
            {
  ...
  const ProjectAvatar = (props: {
    ...
    const kratos = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"

    return (
      <div class="relative size-5 shrink-0 rounded-sm">
        <Avatar
          fallback={name()}
          src={props.project.id === kratos ? "https://kellton-kratos.io/favicon.svg" : props.project.icon?.url}
      ...
      <div class="flex flex-col self-stretch h-full items-center justify-between overflow-hidden min-h-0">
        ...
        <div class="flex flex-col gap-1.5 self-stretch items-start shrink-0 px-2 py-3">
            ...
            <Match when={providers.all().length > 0 && !providers.paid().length && expanded()}>
              <div class="rounded-md bg-background-stronger shadow-xs-border-base">
                <div class="p-3 flex flex-col gap-2">
                  ...
                  <div class="text-text-base">Kellton Kratos includes free models so you can start immediately.</div>
          ...
          <Tooltip placement="right" value="Share feedback" inactive={expanded()}>
            <Button
              as={"a"}
              href="https://kellton-kratos.io/desktop-feedback"
              target="_blank"
              class="flex w-full text-left justify-start text-text-base stroke-[1.5px] rounded-lg px-2"
              variant="ghost"
              size="large"
