...
rustPlatform.buildRustPackage rec {
  ...
  preBuild = ''
    ...
    cp ${args.kratos}/bin/kratos packages/desktop/src-tauri/sidecars/kratos-cli-$targetTriple
  ...
  postInstall = lib.optionalString stdenv.isLinux ''
    ...
    wrapProgram $out/bin/kratos-desktop \
  ...
  meta = with lib; {
    description = "Kellton Kratos Desktop App";
    homepage = "https://kratos.ai";
    license = licenses.mit;
    maintainers = with maintainers; [ ];
    mainProgram = "kratos-desktop";
