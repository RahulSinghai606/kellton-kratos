import solidPlugin from "./packages/kratos/node_modules/@opentui/solid/scripts/solid-plugin"
import path from "path"
import fs from "fs"

const version = "@VERSION@"
const pkg = path.join(process.cwd(), "packages/kratos")
...
const manifestName = "kratos-assets.manifest"
...
const result = await Bun.build({
  ...
  compile: {
    ...
    execArgv: ["--user-agent=kratos/" + version, "--use-system-ca", "--"],
    windows: {},
  },
})
...
const dest = path.join(pkg, "kratos-worker.js")
