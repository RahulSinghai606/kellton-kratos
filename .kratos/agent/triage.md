...
**Only** add if it's specifically about the Desktop application or `kratos web` view. **Do not** add for terminal, TUI, or general kratos issues.
...
**Only** add if the issue mentions "zen" or "kratos zen". Zen is our gateway for coding models. **Do not** add for other gateways or inference providers.
